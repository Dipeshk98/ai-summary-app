...
export function SummaryViewer({summary}:{summary:string}){
    ...
    return(
        <Card
        className="relative px-2 h-[500px] sm:h-[600px] lg:h-[700px] w-full xl:w-[600px] ovrflow-hidden bg-linear-to-br from-background via-background/95 to-rose-500/5
